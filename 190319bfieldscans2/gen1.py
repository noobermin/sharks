...
d=dict(
    ...
    tlim=(-8e-4, 8e-4,
          ...
          -7e-4, 7e-4),
    res =(440,352,220),
    description=" bfield linear scans",
...
bs=[0,0.5e-4,1e-4,1.5e-4,2e-4];
ds=[
    sd(d,pbsbase="Bang2_lI={:3.1f}_s={:2.1f}_ln={:3.1f}_b={:2.1f}".format(
        np.log10(d['I']),sep*1e4,np.log10(N0),ib*1e4),
       multilaser=[
           dict(outlet='xmin',
                laser_dir = (1,0,0),
                laser_pol = (0,1,0),
