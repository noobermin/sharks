[Title]
simulation_title "10um-3e+18-L=1.5um-fn=2.2-cs=2, I = 3.120963e+18 W/cm^2"
;
[Control]
;Time-advance
 time_limit   7.1795e-03
...
;(Diagnostic Output) Dump Intervals
 dump_interval_ns 6.414694138426001e-06
 dump_steps
1 
end
 spatial_skip_x 1
...
;particle_movie_interval_ns 6.414694138426001e-06
...
outlet
from -3.320000e-02 -1.810000e-02 0.000000e+00
to   -3.320000e-02 1.810000e-02 0.000000e+00
phase_velocity 1.0
drive_model LASER
reference_point -0.0185031080897 0.0 0.0 ; focal point position
components 0 1 0
...
outlet
from  6.200000e-03 -1.810000e-02 0.000000e+00
to    6.200000e-03 1.810000e-02 0.000000e+00
phase_velocity 1.0
drive_model NONE
...
plasma ; O+
from -2.800000e-02  -1.290000e-02  0.000000e+00
...
density_function 4
reference_point -2.800000e-02 -1.290000e-02 0.000000e+00
density_flags 1 0 0
...
independent_variable_multiplier 2.051282e-03
;; Emax, intensity=3.120963e+18 W/cm^2
dependent_variable_multiplier   4.849250e+07

function2 ;laser analytic function for lsp v10
type 19   ; f-number: ~2.2152255890697257
          ; \lambda spotsize
coefficients 1.000000e-03 1.410256e-03 end

;;
function3 ; electrons

type 30
data_file 19.23um.dat
