...
d=dict(
    ...
    lspexec='lsp-10-xy -r',
    dir=True,
    totaltime=7086.0e-15, #call zero at 286e-15
    timestep = 160.0e-18,
    ...
    multilaser=[
        dict(
            ...
            laser_t0        = (xmin-fpx)*1e-2/c + 126e-15,
...
r=3
N=2
pbsfmt = 'N2_n{:02}r{}_I={:0.0e}'
def mkpbsbase(N,r,I): return pbsfmt.format(N,r,I);
descrfmt = 'Liquid Nitrogen, I={}'
def mkdescr(I): return descrfmt.format(I);

d['pbsbase']     = mkpbsbase(N,r,d['I']);
d['description'] = mkdescr(d['I']);
gensim(**d);
