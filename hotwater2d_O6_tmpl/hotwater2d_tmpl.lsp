...
outlet
from  {xmax:e} {ymin:e} 0
to    {xmax:e} {ymax:e} 0
phase_velocity 1.0
drive_model NONE
;right
outlet
from {xmin:e}  {ymax:e} 0
to   {xmax:e}  {ymax:e} 0
phase_velocity 1.0
drive_model NONE
;left
...
plasma ; O6+
from {targ_xmin:e}  {targ_ymin:e}  0
to   {targ_xmax:e}  {targ_ymax:e}  0
species 7
movie_tag 3
unbound off
discrete_numbers 3 3 3
density_function 4
reference_point {targ_xmin:e} {targ_ymin:e} 0
density_flags 1 0 0
...
type 30
data_file {targetdat}
dependent_variable_multiplier 8.0
;;
function4 ; Oxygen, 6+
type 30
data_file {targetdat}
